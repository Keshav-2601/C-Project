...
public:
    ...
    bool isWayBlocked() override{
        ...
        if(this->position.first>=10 && this->position.second==0 && this->direction==4){
            return true;
        }
        if(this->position.first==10 && this->position.second>=10 && this->direction==2){
            return true;
        }
        if(this->position.first>=10 && this->position.second==10 && this->direction==1){
            return true;
        }
        return false;
    };
